...
const items = ["Washington", true, 2, 4.12];
console.log(items);
...
const fullName = "WashingtonLuisAndradeBueno"
...
//NamesArry
const names = ['washington', 'luis', 'andrade', 'bueno'];
//Search letter
const letter = 'a';
...
// 6 - Creating e deleting propietes
const car = {
    engine: 2.0,
    brand: "VW",
    model: "Tiguan",
...
// 8 - Getting to know objects better
console.log(Object.keys(obj));
console.log(Object.keys(obj2));
console.log(Object.keys(person));
console.log(Object.entries(obj));

// 9 - Mutation / reference
const a = {
    name: "Washington",
};
...
// 11 - Push e pop - Remove and insert elements at the end of the array
const array = ["a", "b", "c"];
...
// 12 - Shift e unshift - Remove and insert elements at the start of the array
...
// Of part
const words = ['apple', 'banana', 'cat', 'dog', 'ant']
const letra = 'a'
const count = words.filter(word => word.includes(letra)).length
console.log(count)
